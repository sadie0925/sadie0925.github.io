...
|Library|The solution for collecting related functions together for re-use n c++<br />|->Suppose you need information on something: You go to an appropriate library, and access that book|
